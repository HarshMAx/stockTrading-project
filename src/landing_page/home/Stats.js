        ...
        <div className='container p-5'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='fs-5 text-muted'>With initiativeslike Nudge and Kill Switch, we don't just facilitate transactions, but actively help you do better with money.</p>
                </div>
                <div className='col-6'>
                    <img src='media/images/ecosystem.png' style={{ width: "98%" }} />
                    <div className='text-center'>
                        ...
                        <a href='' className='fs-5' style={{textDecoration:"none"}}>Try kite <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
